...
public class AguardaJogadaPane extends BorderPane{
    ...
    private Label lbJogadorAtual, lbJogador1, lbJogador2, lbJogadorVirtual;
    ...
    private void dispoeVista(){
        ...
        lbJogadorAtual.setBorder(new Border(new BorderStroke(Color.DARKGRAY, BorderStrokeStyle.SOLID, null, new BorderWidths(3))));
    ...
    private void registaObservador(){
        ...
        jogObs.addPropertyChangelistener(PROP_JOGADORES, evt ->{atualizaJogadores();});
    ...
    private void atualiza(){
        if(jogObs.getSituacaoAtual() == Situacao.AguardaJogada) {
            ...
            lbJogadorAtual.setText(" " + jogObs.getJogadorAtual().getNome() + " ");
